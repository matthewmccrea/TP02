...
public class Persona {
	...
	public Persona (String colorDeOjos, int edad) {
		this.setColorDeOjos(colorDeOjos);
		this.setEdad(edad);
		this.pasosRealizados=0;
	}
	...
	public void caminarPasos (int pasos) {
		this.setPasosRealizados(this.getPasosRealizados()+pasos);
	}
